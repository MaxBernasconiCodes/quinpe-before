...
//if(empty($_SESSION['TxtDocCong'])){echo GLO_formbutton('CmdBuscarCH','submit','','self','Buscar','lupa','iconbtn',6,0,0);} 
?>
...
<table width="760" border="0"  cellspacing="0" class="Tabla TMT" >
<tr> <td width="110" height="5"  ></td> <td width="300"></td><td width="110"></td> <td width="240"></td></tr>
<tr> <td height="18"  align="right"  >Dominio:</td><td >&nbsp;<input name="TxtDominio" type="text"  class="TextBox" style="width:100px;" maxlength="10"  tabindex="8"   value="<? echo $_SESSION['TxtDominio']; ?>" onKeyUp="this.value=this.value.toUpperCase()"  placeholder="Buscar dominio" /> <? if(empty($_SESSION['TxtDominioCong'])){echo GLO_formbutton('CmdBuscarD1','submit','','self','Buscar','lupa','iconbtn',8,0,0);} ?></td><td align="right"  >Verif.Tecnica:</td><td><input name="ChkU1"  type="checkbox" class="check" tabindex="9"  value="1" <? if ($_SESSION['ChkU1'] =='1') echo 'checked'; ?>> <?php  GLO_calendariovto("TxtFechaU1","../Codigo/","actual",9); ?></td></tr>
...
<table width="760" border="0"  cellspacing="0" class="Tabla TMT" >
<tr> <td width="110" height="5"  ></td> <td width="300"></td><td width="110"></td> <td width="240"></td></tr>
<tr> <td height="18"  align="right"  >Dominio:</td><td >&nbsp;<input name="TxtDominio2" type="text"  class="TextBox" style="width:100px;" maxlength="10"  tabindex="10"   value="<? echo $_SESSION['TxtDominio2']; ?>" onKeyUp="this.value=this.value.toUpperCase()"  placeholder="Buscar dominio" />  <? if(empty($_SESSION['TxtDominio2Cong'])){echo GLO_formbutton('CmdBuscarD2','submit','','self','Buscar','lupa','iconbtn',10,0,0);} ?></td><td align="right"  >Verif.Tecnica:</td><td><input name="ChkS1"  type="checkbox" class="check"  tabindex="11" value="1" <? if ($_SESSION['ChkS1'] =='1') echo 'checked'; ?>> <?php  GLO_calendariovto("TxtFechaS1","../Codigo/","actual",11); ?></td></tr>
