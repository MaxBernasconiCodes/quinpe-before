...
<tr > <td height="20"  valign="bottom"  width="160"><input type="button" class="botoniniciomenu"  style="width:140px;" value="COMPRAS"></td><td height="20"  valign="bottom"  width="160"><input type="button" class="botoniniciomenu"  style="width:140px;" value="MANTENIMIENTO"></td><td valign="bottom"  width="160"><input type="button" class="botoniniciomenu"  style="width:140px;" value="SGI"></td> </tr>
