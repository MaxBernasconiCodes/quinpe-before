...
$ident=intval($_POST['TxtNroEntidad']);//instrumento (id accesorios)
$idinstr=intval($_POST['CbInstrumento']);//instrumento (id accesorios)
//
$id=intval($_POST['TxtNumero']);//asignacion
$pers=intval($_POST['CbPersonal']);
$uni=intval($_POST['CbUnidad']);//autorizante
//
