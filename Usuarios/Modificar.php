...
GLOF_Init('CbPerfil','BannerConMenuHV','zModificar',0,'MenuH',0,0,0); 
...
<tr><td height="21"  align="right"  >Perfil:</td><td valign="top" >&nbsp;<select name="CbPerfil"  class="campos" id="CbPerfil" style="width:200px"> <? USR_ComboPerfil(1,$conn); ?> </select> <label class="MuestraError"> * </label></td></tr>
