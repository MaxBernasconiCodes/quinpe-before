...
function drawChart1() {
  ...
  var options = {'title':'Nomina por Sector', 'width':500, 'height':400,'legend':{textStyle:{fontSize : 9}}};
...
function drawChart2() {
  ...
  var data = google.visualization.arrayToDataTable(dataphp);
  var options = {'title':'Nomina por Estudios', 'width':500, 'height':400,'legend':{textStyle:{fontSize : 9}}};
...
function drawChart3() {
  ...
  var data = google.visualization.arrayToDataTable(dataphp);
  var options = {'title':'Nomina por Edad', 'width':500, 'height':400,'legend':{textStyle:{fontSize : 9}}};
...
function drawChart4() {
  ...
  var data = google.visualization.arrayToDataTable(dataphp);
  var options = {'title':'Nomina por Antig. Empresa', 'width':500, 'height':400,'legend':{textStyle:{fontSize : 9}}};
