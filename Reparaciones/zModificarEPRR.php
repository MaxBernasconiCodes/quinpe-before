...
if (isset($_POST['CmdAceptar'])){
	...
	if ( empty($_POST['TxtFecha']) ){
		...
		GLO_feedback(3);header("Location:ModificarEPRR.php?id=".intval($_POST['TxtNumero']));
		...
		$query="UPDATE pedidosrepreq_hist set Fecha='$fecha' Where Id=".intval($_POST['TxtNumero']);$rs=mysql_query($query,$conn);
