...
GLO_adjuntarcomentario('mantenimiento','alta','ModificarReq','Acci&oacute;n','BannerPopUp','FooterConUsuario','pedidosrepreq_com',intval($_GET['id']),intval($_GET['identidad']));
