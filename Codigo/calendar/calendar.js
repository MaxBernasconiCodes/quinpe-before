...
function tc_setDay(objname, dvalue, path,vararbol){
	...
	if(!isDateAllow(objname, dvalue, date_array[1], date_array[0])){
		...
		if(isDate(dvalue, date_array[1], date_array[0])){
			...
			obj.src = +vararbol+"Codigo/calendar/calendar_form.php?objname="+objname.toString()+"&sel_day="+dvalue+"&sel_month="+date_array[1]+"&sel_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar;
...
function tc_setMonth(objname, mvalue, path,vararbol){
	var obj = document.getElementById(objname);
	var date_array = obj.value.split("-");
	...
	if(!isDateAllow(objname, date_array[2], mvalue, date_array[0])){
		...
		if(isDate(date_array[2], mvalue, date_array[0])){
			...
			obj.src = +vararbol+"Codigo/calendar/calendar_form.php?objname="+objname.toString()+"&sel_day="+date_array[2]+"&sel_month="+mvalue+"&sel_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar;
...
function tc_setYear(objname, yvalue, path,vararbol){
	var obj = document.getElementById(objname);
	var date_array = obj.value.split("-");
	...
	if(!isDateAllow(objname, date_array[2], date_array[1], yvalue)){
		...
		if(isDate(date_array[2], date_array[1], yvalue)){
			...
			obj.src = +vararbol+"Codigo/calendar/calendar_form.php?objname="+objname.toString()+"&sel_day="+date_array[2]+"&sel_month="+date_array[1]+"&sel_year="+yvalue+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar;
