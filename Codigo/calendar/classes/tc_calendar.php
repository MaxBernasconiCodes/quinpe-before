...
class tc_calendar{
	...
	function getDayHeaders(){
		if($this->startMonday)
			return array("1"=>"Lu", "2"=>"Ma", "3"=>"Mi", "4"=>"Ju", "5"=>"Vi", "6"=>"Sa","7"=>"Do");
		else
			return array("7"=>"Do", "1"=>"Lu", "2"=>"Ma", "3"=>"Mi", "4"=>"Ju", "5"=>"Vi", "6"=>"Sa");
	}
	...
	function writeScript(){
		...
		$params[] = "sel_day=".$this->day;
		$params[] = "sel_month=".$this->month;
		$params[] = "sel_year=".$this->year;
	...
	function writeDay(){
		echo("<select name=\"".$this->objname."_day\" id=\"".$this->objname."_day\" onChange=\"javascript:tc_setDay('".$this->objname."', this[this.selectedIndex].value, '$this->path','".$_SESSION["NivelArbol"]."');\" class=\"tcday\">");
	...
	function writeMonth(){
		echo("<select name=\"".$this->objname."_month\" id=\"".$this->objname."_month\" onChange=\"javascript:tc_setMonth('".$this->objname."', this[this.selectedIndex].value, '$this->path','".$_SESSION["NivelArbol"]."');\" class=\"tcmonth\">");
	...
	function writeYear(){
		...
		echo("<select name=\"".$this->objname."_year\" id=\"".$this->objname."_year\" onChange=\"javascript:tc_setYear('".$this->objname."', this[this.selectedIndex].value, '$this->path','".$_SESSION["NivelArbol"]."');\" class=\"tcyear\">");
