...
GLO_datostablabasica('pedidosrepreq_tipo',intval($_GET['id']));

GLOF_tablabasica(30,0,'../Reparaciones/MenuH','TIPO ACCION','BannerConMenuHV','FooterConUsuario','zModificar'); 
