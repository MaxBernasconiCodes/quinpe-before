...
GLO_datostablabasica('pedidosrepreq_clase',intval($_GET['id']));

GLOF_tablabasica(30,0,'../Reparaciones/MenuH','CLASE ACCION','BannerConMenuHV','FooterConUsuario','zModificar'); 
