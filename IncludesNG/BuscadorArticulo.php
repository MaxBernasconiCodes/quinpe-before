...
//query
if ($_SESSION['TxtExCriterio']!=""){//si es una b&uacute;squeda
	$query="(SELECT a.Id,a.Nombre,a.Modelo, m.Nombre as Marca,u.Abr FROM epparticulos a,unidadesmedida u,marcas m where a.Id<>0 and a.FechaBaja='0000-00-00' and a.IdUnidad=u.Id and a.IdMarca=m.Id and (a.Nombre Like '%".$criterio."%' or a.Id=$criterio2) Order by a.Nombre)";
