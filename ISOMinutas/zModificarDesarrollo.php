...
if (isset($_POST['CmdAceptar'])){
	...
	if ( empty($_POST['TxtNombre']) ){
		...
		GLO_feedback(3);header("Location:ModificarDesarrollo.php?id=".intval($_POST['TxtNumero']));
		...
		$query="UPDATE iso_minutas_des set Obs='$obs' Where Id=".intval($_POST['TxtNumero']);
