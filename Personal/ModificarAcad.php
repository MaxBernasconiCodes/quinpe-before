...
if ($_GET['Flag1']=="True"){
	$query="SELECT p.* From personal_acad p where p.Id<>0 and p.Id=".intval($_GET['id']);$rs=mysql_query($query,$conn);
...
GLOF_Init('TxtFechaA','BannerPopUp','zModificarAcad',0,'',0,0,0); 
