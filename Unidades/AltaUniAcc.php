...
GLOF_Init('','BannerPopUp','zAltaUniAcc',0,'',0,0,0); 
GLO_tituloypath(0,600,'','UNIDADES ACCESORIAS','salir');
?> 


<table width="600" border="0"   cellspacing="0" class="Tabla" >
<tr><td width="100" height="3"  ></td>  <td width="500"></td></tr>
<tr><td height="18"  align="right"  >Unidad Accesoria:</td><td  valign="top" >&nbsp;<select name="CbUnidad" style="width:300px" class="campos" id="CbUnidad"  tabindex="1" ><option value=""></option> <? GLO_ComboActivoUni("unidades","CbUnidad","Nombre","","",$conn); ?> </select><label class="MuestraError"> * </label></td></tr>
</table>
