...
<tr><td height="18"  align="right"  >Tipo:</td><td  valign="top">&nbsp;<select name="CbTipo" style="width:300px" class="campos" id="CbTipo"  tabindex="1" ><option value=""></option> <? ComboTablaRFX("unidadesvtos_tipos","CbTipo","Nombre","","",$conn); ?> </select><label class="MuestraError"> * </label><input  name="TxtNroEntidad" type="hidden"   value="<? echo $_SESSION['TxtNroEntidad'];?>"><input  name="TxtNumero" type="hidden" value="<? echo $_SESSION['TxtNumero']; ?>"><input  name="TxtId" type="hidden" value="<? echo $_SESSION['TxtId']; ?>"></td><td align="right"></td><td><input name="ChkReq"  type="checkbox"  class="check" value="1" <? if ($_SESSION['ChkReq'] =='1') echo 'checked'; ?>> Requerido</td></tr>
<tr><td height="18"  align="right"  >Emisi&oacute;n:</td><td  valign="top">&nbsp;<input name="TxtFechaA" id="TxtFechaA"   type="text" class="TextBox"  style="width:70px;" maxlength="10" tabindex="2" onChange="this.value=validarFecha(this.value);" value="<? echo $_SESSION['TxtFechaA']; ?>"      ><label class="MuestraError"> * </label><?php  calendario("TxtFechaA","../Codigo/","actual"); ?></td><td align="right"></td><td><input name="ChkInactivo"   type="checkbox"  class="check" value="1" <? if ($_SESSION['ChkInactivo'] =='1') echo 'checked'; ?>>Inactivo</td></tr>
...
<? GLO_obsform(700,100,'Observaciones','TxtObs',1,0);  ?>
