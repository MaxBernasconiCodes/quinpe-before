...
if (isset($_POST['CmdAceptar'])){ 
	...
	if ((empty($_POST['CbTipo'])) or (empty($_POST['TxtFechaA'])) ){
		...
		$nroId=GLO_generoID('unidadesvtos',$conn);

		$query="INSERT INTO unidadesvtos (Id,IdEntidad,IdTipo,FechaE,Fecha,Req,Certif,Obs,Inactivo) VALUES ($nroId,$ident,$tipo,'$fechaa','$fechab',$req,'','$obs',$inac)";$rs=mysql_query($query,$conn);
