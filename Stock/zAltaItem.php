...
if (isset($_POST['CmdAceptar'])){
	...
	if ( ( intval($_POST['CbItem'])==0 and intval($_POST['CbItem2'])==0 and empty($_POST['TxtObs'])) or (floatval($_POST['TxtCantidad'])==0) ){
		...
		if(intval($_POST['CbItem'])!=0 and intval($_POST['CbItem2'])!=0){
			...
			$query="INSERT INTO stockmov_items (Id,IdMov,IdArticulo,Cantidad,CantidadCS,IdNP,IdItemNP,IdUser,IdItem,IdCAM,IdPedido,IdUniIT,IdEnvIT,LoteIT,Etapa,CantSinFactor) VALUES ($nroId,$ident,$iditem,$cant,$cantcs,0,0,$paudi,$iditem2,$idcam,0,0,0,'',0,0)";
