...
if(mysql_num_rows($rs)!=0){ $_SESSION['TxtDep']=$row['IdDeposito']; $_SESSION['TxtTipo']=$row['IdTipoMov'];}
...
<tr><td align="right"><input name="CmdAddA" type="submit" class="boton02" value="Crear Art&iacute;culo" style=" width:90px" onClick="document.Formulario.target='_blank';document.forms['Formulario']['TxtExCriterio'].focus()"></td> </tr>
</table>
