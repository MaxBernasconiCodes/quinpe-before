...
if(isset($_POST['CmdAceptar'])) {
    if (is_uploaded_file($_FILES['archivo']['tmp_name'])) {	
		...
		$nroId=GLO_generoID('iso_doc_evi',$conn);	
		//file
		...
		$query="INSERT INTO iso_doc_evi (Id,IdDoc,Descripcion,Ruta,FechaU,Anio) VALUES ($nroId,$iddoc,'$obs','$nombrearchivo','$fecha',$anio)";
