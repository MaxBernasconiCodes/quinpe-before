...
$query="SELECT * From iso_doc_evi Where Id=".intval($_SESSION['TxtNumero']);$rs=mysql_query($query,$conn);
while($row=mysql_fetch_array($rs)){	
	$_SESSION['TxtDesA'] =$row['Descripcion'];
...
echo'<form name="Formulario" action="zModificarEvidencia.php" method="post" enctype="multipart/form-data">';
GLO_tituloypath(0,700,'','EVIDENCIA','salir');
...
echo '<table width="700" border="0"   cellspacing="0" class="Tabla TMT" >
<tr> <td width="100" height="5"  ></td> <td width="600"></td> </tr>
<tr> <td height="18"  align="right">A&ntilde;o:</td><td  valign="top" >&nbsp;<input name="TxtAnio" type="text" "  class="TextBox" style="width:70px" maxlength="4"  value="'.$_SESSION['TxtAnio'].'" onChange="this.value=validarEntero(this.value);" ></td></tr>
</table>';
